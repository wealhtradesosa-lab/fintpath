...
const estimarImpuesto=(u)=>{
  ...
  const gasRaw=u.gas||{};const gas={};Object.entries(gasRaw).forEach(([cat,items])=>{const fi=(items||[]).filter(g=>g.sim!==false);if(fi.length>0)gas[cat]=fi});
