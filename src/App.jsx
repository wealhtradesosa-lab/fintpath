    ...
    return<div>
      ...
      {!has&&<div style={{marginBottom:24}}>
        <div style={{background:"linear-gradient(135deg,rgba(34,197,94,.08),rgba(6,182,212,.05))",border:"1px solid rgba(34,197,94,.15)",borderRadius:16,padding:28}}>
          <div style={{textAlign:"center",marginBottom:20}}><div style={{fontSize:36,marginBottom:8}}>👋</div><h3 style={{fontSize:22,fontWeight:800,margin:"0 0 6px",letterSpacing:"-0.02em"}}>Bienvenido a FINPATH</h3><p style={{color:T.tx2,fontSize:14,margin:0}}>Tu plataforma de gestión patrimonial</p></div>
