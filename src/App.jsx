...
export default function FinPath(){
  ...
  if(!u&&!showAuth){
    ...
    return<><LandingPage onGetStarted={(meta)=>{const from=meta?.source||"home";if(from==="renta")sAM("signup");track("signup_modal_opened",{from,...(meta?.dias_restantes!=null?{dias_restantes:meta.dias_restantes}:{})});setShowAuth(true)}}/><PWAInstallPrompt/></>;
  }
