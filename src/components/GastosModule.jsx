...
const DIAN_REGLAS = {
  natural: { "Salud": "✅ Deducible", "Vivienda": "✅ Deducible", "Seguros": "📊 50%", "Pensión voluntaria": "✅ Deducible", "Alimentación": "❌", "Transporte": "❌", "Servicios": "❌", "Educación": "❌", "Entretenimiento": "❌", "Personal": "❌", "Vestimenta": "❌", "Ahorro": "❌", "Impuestos": "❌", "Otro": "❌" },
  juridica: { "Salud": "❌", "Vivienda": "✅ Deducible", "Seguros": "✅ Deducible", "Servicios": "✅ Deducible", "Transporte": "✅ Deducible", "Educación": "📊 50%", "Pensión voluntaria": "✅ Deducible", "Alimentación": "❌", "Entretenimiento": "❌", "Personal": "❌", "Vestimenta": "❌", "Ahorro": "❌", "Impuestos": "❌", "Otro": "📊 50%" }
};
        ...
        <div onClick={() => setShowForm(false)} style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.6)", backdropFilter: "blur(8px)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1000, padding: 20 }}>
          <div onClick={(e) => e.stopPropagation()} style={{ background: T.bg2, border: `1px solid ${T.border}`, borderRadius: 20, width: "100%", maxWidth: 520, padding: 32 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
              <In l="Categoría" value={form.cat} onChange={(v) => setForm((p) => ({ ...p, cat: v }))} options={[{v:"Vivienda",l:"🏠 Vivienda (arriendo, hipoteca, admin)"},{v:"Alimentación",l:"🛒 Alimentación y mercado"},{v:"Transporte",l:"🚗 Transporte"},{v:"Educación",l:"📚 Educación"},{v:"Salud prepagada",l:"🏥 Salud prepagada / medicina voluntaria"},{v:"Seguridad social",l:"🏛️ Seguridad social (pensión, EPS, ARL)"},{v:"Seguros",l:"🛡️ Seguros (vida, hogar, auto)"},{v:"Servicios",l:"💡 Servicios (luz, agua, internet)"},{v:"Impuestos",l:"🧾 Impuestos (predial, vehicular, ICA)"},{v:"Entretenimiento",l:"🎬 Entretenimiento y ocio"},{v:"Vestimenta",l:"👔 Vestimenta"},{v:"Tecnología",l:"💻 Tecnología"},{v:"Mascotas",l:"🐾 Mascotas"},{v:"Deporte",l:"⚽ Deporte y bienestar"},{v:"Personal",l:"👤 Gastos personales"},{v:"Ahorro",l:"💰 Ahorro e inversión"},{v:"Otro",l:"📝 Otro"}]} />
