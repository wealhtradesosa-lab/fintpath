...
export default function LandingAsesores({ onGetStarted }) {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Infraestructura Supabase con conexión segura (HTTPS/TLS). Row Level Security a nivel de base de datos garantiza que cada asesor solo ve los clientes que le corresponden.",
    },
  ];
        ...
        <Section>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 16 }}>
            {[
              ...
              { icon: "🔒", title: "Seguridad institucional", desc: "Conexión segura (HTTPS/TLS). RLS a nivel de base de datos: cada asesor solo ve sus clientes.", color: T.gold },
