      ...
      <div style={{ background: T.bg2, borderTop: `1px solid ${T.border}`, padding: "80px 0" }}>
        <Section>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 16, maxWidth: 800, margin: "0 auto" }}>
            {[
              { i: "🔒", t: "Datos encriptados", d: "Tu información financiera está protegida con encriptación y Row Level Security" },
              { i: "👤", t: "Solo tú accedes", d: "Cada usuario solo puede ver sus propios datos. Nadie más." },
              { i: "🚫", t: "Sin publicidad", d: "No vendemos ni compartimos tu información. Nunca." },
              { i: "🗑️", t: "Borras cuando quieras", d: "Tus datos son tuyos. Bórralos con un click si quieres." },
            ].map((item) => (
